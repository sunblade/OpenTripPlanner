# Czech translation for OpenTripPlanner.
# Copyright (C) 2016
...
"Language-Team: OpenTripPlanner DESOSA 2016 <p.s.tekieli@student.tudelft.nl>\n"
"MIME-Version: 1.0\n"
"Content-Type: text/plain; charset=UTF-8\n"
"Content-Transfer-Encoding: 8bit\n"
"Generated-By: Babel 1.3\n"
"X-Generator: Poedit 1.8.7\n"
"Last-Translator: Piotr Tekieli <p.s.tekieli@student.tudelft.nl>\n"
...
msgstr ""
"Zarówno lokalizacja startowa, jak i końcowa, nie oferuje udogodnień dla osób "
"niepełnosprawnych."
...
"options, or be more specific."
msgstr ""
"Zarówno lokalizacja początkowa, jak i końcowa nie została poprawnie "
"ziterpretowana przez planer podróży. Prosimy o wybranie pozycji dostępnych "
"na liście poniżej, bądź sprecyzować zapytanie."
...
msgid ""
"If OptimizeType is TRIANGLE, triangleSafetyFactor, triangleSlopeFactor, and "
"triangleTimeFactor must be set"
msgstr ""
"Jeśli wartość pola OptimizeType wskazuje na TRIANGLE (TRÓJKĄT), należy podać "
"parametry zmiennych triangleSafetyFactor, triangleSlopeFactor oraz "
"triangleTimeFactor."
...
#, python-format
msgid ""
"Take roundabout <b>counterclockwise</b> to <b>%(ordinal_exit_number)s</b> "
"exit on <b>%(street_name)s</b>"
msgstr ""
"Przejedź przez rondo <b>przeciwnie do ruchów wskazówki zegara</b> do <b>"
"%(ordinal_exit_number)s</b> wyjazdu na ulicę <b>%(street_name)s</b>"
...
#, python-format
msgid ""
"Take roundabout <b>clockwise</b> to <b>%(ordinal_exit_number)s</b> exit on "
"<b>%(street_name)s</b>"
msgstr ""
"Przejedź przez rondo <b>zgodnie z ruchem wskazówki zegara</b> do <b>"
"%(ordinal_exit_number)s</b> wyjazdu na ulicę <b>%(street_name)s</b>"
...
msgid "Maximum walk"
msgstr "Maksymalna długość trasy pieszej"
...
msgid "Maximum bike"
msgstr "Maksymalna długość trasy do pokonania rowerem"
...
#. In Bike share planner radio button: <Use>: My Own Bike A shared bike
